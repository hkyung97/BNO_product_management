  ...
  <div class="container">
    <div class="Rectangle1">
      <div>
        ...
        <div class="button">
          ...
          <router-link :to="'/productedit/' + (product1 ? product1.prdid : '')">
            <button class="register-button" v-if="isCurrentUserAuthor">
              수정
            </button> </router-link
          >&nbsp;
          <button
            class="register-button1"
      ...
      <div class="Rectangle6">
        <img
          :src="product1 ? product1.imgpath : '/loading.gif'"
          alt="Product Image"
      ...
      <div class="loading" v-else>데이터를 불러오는 중...</div>
    </div>
  </div>
</template>
